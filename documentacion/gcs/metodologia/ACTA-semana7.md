# Acta de trabajo — Práctica grupal Semana 7 (GCS)

**Proyecto:** TecnoMovil
**Módulo trabajado esta semana:** Autenticación (acceso biométrico/PIN en Android y bloqueo de login por intentos fallidos en escritorio)
**Fecha:** 2026-08-29

## Roles y entregables

| Integrante | Rol en la práctica | Entregable a cargo | Evidencia |
| --- | --- | --- | --- |
...
## Correspondencia acta ↔ evidencia

Cada fila de esta acta se verifica con un enlace real, no con una descripción:
