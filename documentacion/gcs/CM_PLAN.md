...
| `v1.1.1` | `44d0a5b` | Corrección de CI de frontend rota por `v1.1.0` (Issue #3, PR #4) | [`releases/v1.1.1.md`](releases/v1.1.1.md) |
| `v1.2.0` | `c968556` | Bloqueo de login tras intentos fallidos (Issue #5, RFC-001, PR #6) | [`releases/v1.2.0.md`](releases/v1.2.0.md) |
